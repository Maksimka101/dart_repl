...
class EditableCode extends StatefulWidget {
  ...
  ///
  /// The cursor refers to the blinking caret when the [EditableCode] is focused.
  /// {@endtemplate}
  ///
  /// See also:
  ///
  ...
  ///
  /// For [CupertinoTextField]s, the value is set to the ambient
  /// [CupertinoThemeData.primaryColor] with 20% opacity.
  final Color selectionColor;

  /// {@template flutter.widgets.editableText.selectionControls}
  /// Optional delegate for building the text selection handles and toolbar.
  ///
  /// The [EditableCode] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [EditableCodeState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [EditableCode] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [EditableCode], which
  ...
  ///
  /// The [mouseCursor] is the only property of [EditableCode] that controls the
  ...
  /// [EditableCode].
  ///
  /// If a restoration id is provided, the [EditableCode] will persist its
  /// current scroll offset and restore it during state restoration.
  ///
  /// The scroll offset is persisted in a [RestorationBucket] claimed from
  /// the surrounding [RestorationScope] using the provided restoration ID.
  ///
  /// Persisting and restoring the content of the [EditableCode] is the
  ...
  @override
  EditableCodeState createState() => EditableCodeState();
...
/// State for a [EditableCode].
class EditableCodeState extends State<EditableCode>
    with
        AutomaticKeepAliveClientMixin<EditableCode>,
        WidgetsBindingObserver,
        TickerProviderStateMixin<EditableCode>
  ...
  @override
  void didUpdateWidget(EditableCode oldWidget) {
  ...
  /// update via [updateEditingValue], or when [EditableCode] calls
  ...
  ///
  /// Throws an error in debug mode if this [EditableCode] is not in a batch
  /// edit.
  void endBatchEdit() {
    _batchEditDepth -= 1;
    assert(
  ...
  void _startCursorTimer() {
    ...
    if (EditableCode.debugDeterministicCursor) return;
    if (widget.cursorOpacityAnimates) {
      _cursorTimer =
          ...
          return CompositedTransformTarget(
            ...
            child: Semantics(
              ...
              child: _Editable(
                ...
                showCursor: EditableCode.debugDeterministicCursor
