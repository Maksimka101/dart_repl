...
import 'package:dart_repl/code_editor/_editable_text_copy.dart';
...
class _TextFieldSelectionGestureDetectorBuilder
  ...
  _TextFieldSelectionGestureDetectorBuilder({
    @required _TextCodeFieldState state,
  })  : _state = state,
        super(delegate: state);

  final _TextCodeFieldState _state;
...
///
/// To integrate the [TextCodeField] into a [Form] with other [FormField] widgets,
...
///
/// {@tool snippet}
/// This example shows how to create a [TextCodeField] that will obscure input. The
...
class TextCodeField extends StatefulWidget {
  ...
  /// [TextCodeField.noMaxLength] then only the current length is displayed.
  ///
  ...
  const TextCodeField({
    ...
    this.restorationId,
        ...
        assert(maxLength == null ||
            maxLength == TextCodeField.noMaxLength ||
            maxLength > 0),
  ...
  /// to [TextCodeField.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforcement] is set to
  /// [MaxLengthEnforcement.none].
  ...
  /// which is evaluated after the supplied [inputFormatters], if any.
  ///
  /// This value must be either null, [TextCodeField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [TextCodeField.noMaxLength], then no limit will
  ...
  ///
  /// The [mouseCursor] is the only property of [TextCodeField] that controls the
  ...
  @override
  _TextCodeFieldState createState() => _TextCodeFieldState();
...
class _TextCodeFieldState extends State<TextCodeField>
  ...
  @override
  void didUpdateWidget(TextCodeField oldWidget) {
